    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="reveal text-center mb-24 md:mb-32">
          ...
          <p className="reveal reveal-delay-1 font-sans text-cream-dim font-light text-lg max-w-lg mx-auto leading-relaxed mb-12">
          ...
          <Link
            ...
            className="reveal reveal-delay-2 inline-flex items-center gap-3 border border-gold/40 text-gold text-xs tracking-widest uppercase font-sans font-medium px-10 py-4 hover:bg-gold hover:text-off-black active:scale-95 transition-all duration-300"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          <div>
            ...
            <h3 className="reveal reveal-delay-1 font-serif text-3xl md:text-4xl text-cream mb-6">
